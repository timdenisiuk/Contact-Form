    ...
    <>
      ...
      <div className="box-border p-0 m-0 font-sans font-bold bg-blue-200">
        <main className="flex flex-col items-center min-h-screen p-8">
          <h1 className="text-2xl text-center sm:text-center lg:text-5xl lg:pb-5">Contact us!</h1>
          <p className="lg:text-xl">Questions? Comments? Concerns?</p>
          <p className="lg:text-xl">Send us an email, and we will get back to you</p>
          <p className="lg:text-xl lg:pb-28">as soon as possible!</p>
